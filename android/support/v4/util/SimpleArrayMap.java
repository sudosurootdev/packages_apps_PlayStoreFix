...
label0:
            {
                synchronized(android/support/v4/util/ArrayMap)
                {
...
_L2:
    ...
    private static void freeArrays(int ai[], Object aobj[], int i)
    {
        ...
        /*<invalid signature>*/java.lang.Object local = android/support/v4/util/ArrayMap;
...
_L1:
        ...
        local = android/support/v4/util/ArrayMap;
        JVM INSTR monitorenter ;
