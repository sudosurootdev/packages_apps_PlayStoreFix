    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        for(int k1 = 0; k1 < j1; k1++)
        {
            ...
            case 16: // '\020'
                ...
                if(i3 + i2 > l2 - layoutparams.bottomMargin)
                    i3 = l2 - layoutparams.bottomMargin - i2;
                view.layout(j2, i3, j2 + l1, i3 + i2);
                break;

            case 80: // 'P'
                int k2 = l - j;
                view.layout(j2, k2 - layoutparams.bottomMargin - view.getMeasuredHeight(), j2 + l1, k2 - layoutparams.bottomMargin);
                break;
